...
const TEST_INNS = [
  // "7894561232" — «Flat»: настоящее агентство с выдуманным ИНН, 76 брокеров; владелец 07.09: НЕ удалять.
  "1232133424",
  "1234567891",
  "121234233221",
  "1234567897",
  ...
  "123456678945",
  "1178885692",
  // 2026-09-07 (решение владельца): карточка «Агентство 7707083893» — ИНН Сбербанка,
  // тестовый ввод; удалить (связи брокеров, если есть, снимаются скриптом).
  "7707083893",
];
