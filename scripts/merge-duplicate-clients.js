...
async function main() {
  ...
  try {
    ...
    for (const g of groups) {
      ...
      audit.push({ keeper: keeper.id, dups: dups.map((d) => ({ id: d.id, createdAt: d.createdAt.toISOString(), deals: d._count.deals, meetings: d._count.meetings, uniquenessStatus: d.uniquenessStatus })), patch: Object.keys(patch) });
