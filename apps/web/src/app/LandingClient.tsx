    ...
    <section id="materials" style={{background:'var(--bg)'}}>
      ...
      {roots.length === 0 ? (
        ...
        /* 2026-09-18 (владелец): блок разъезжался на разных экранах и оставлял
           ...
           (2026-09-24: комментарий в JSX-скобках рядом с элементом ломал
           сборку — «Expected '</'»; поэтому обычный JS-комментарий.) */
          ...
          <div className="coop-grid" style={{alignItems:'stretch'}}>
            <div className="coop-left" style={{display:'flex',flexDirection:'column',gap:12}}>
              ...
              {(() => {
                ...
                return (
                  // 2026-09-09: класс нужен, чтобы на телефоне сетка схлопывалась в
                  // один столбец. Без него два столбца по 188 px держали минимальную
                  // ширину страницы 405 px, и браузер уменьшал масштаб всего лендинга
                  // на экранах 360–390 px (iPhone SE/13 mini, бюджетные Android).
                  <div className="coop-managers" style={{display:'grid',gridTemplateColumns: list.length > 1 ? '1fr 1fr' : '1fr',gap:10}}>
