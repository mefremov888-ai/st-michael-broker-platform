...
import { LoyaltyRecordPage } from "@/components/loyalty-base/LoyaltyRecordDetailV2";
...
export default function LoyaltyBaseDetailRoute() {
  const { base, entity, id } = useParams<{
    base: string;
    entity: string;
    id: string;
  }>();
  ...
  if (loading)
    return (
      <div className="card py-20 flex items-center justify-center gap-2 text-text-muted">
