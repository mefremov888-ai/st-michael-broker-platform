      ...
      >
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          ...
          <Field label="Период звонков">
            ...
            {/* 2026-09-10 (владелец: «меняю даты — список не меняется»):
                период задаёт, какие звонки считать, но сам по себе выборку не
                сокращает. Пишем об этом прямо под полем. */}
            {(draft.callFrom || draft.callTo) && (
              <p className="mt-1 text-xs text-text-muted">
                Период задаёт, какие звонки считать. Чтобы он сократил список,
                поставьте в колонке «Прошлые обзвоны» — «Звонили в период» или
                «Не звонили в период».
              </p>
            )}
          </Field>
